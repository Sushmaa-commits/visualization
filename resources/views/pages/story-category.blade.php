@extends('layouts.app')
@section('content')
<section id="archive-stories" class="view-archive-stories">
    <div class="container">
        ...
        <div id="masonry" class="masonry group" style="position: relative; height: 2425.06px;">
                    ...
                    <article class="article template-article-excerpt not-hide" style="position: absolute; left: 0px; top: 0px;">
                        <figure>
                            ...
                            <a href="/story/{{$story->id}}">
                                <img width="440" height="650" src="/storage/{{str_replace("\"","",$story->imagesArr[0])}}"
                                    class="cover" alt=""> </a>
                        </figure>
                        <div class="content">
                            <aside class="meta">
